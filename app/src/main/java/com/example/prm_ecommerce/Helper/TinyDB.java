...
public class TinyDB {
    ...
    public ArrayList<ItemCartDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ItemCartDomain> playerList =  new ArrayList<ItemCartDomain>();

        for(String jObjString : objStrings){
            ItemCartDomain player  = gson.fromJson(jObjString,  ItemCartDomain.class);
    ...
    public void putListObject(String key, ArrayList<ItemCartDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ItemCartDomain player: playerList){
